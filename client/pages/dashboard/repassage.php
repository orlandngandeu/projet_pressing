...
<html lang="en">
   ...
   <div class="dashboard-container">
      ...
      <main class="main-container">
        <div class="sujet">
            <h1 class="main-title">Gestion des repassages</h1>
        ...
        <div class="contenu">
            <section class="container py-5">
                ...
                <div class="entreligne">
                    <div><h5 class="fw-bold md-8">Listes des repassages</h5></div>
                    <div class="operation">
                        <div class="d-flex justify-content-end">
                            ...
                            <a href="../../../server/php/rep.php?action=export" class="btn btn-success btn-sm" id="export">
                ...
                <div class="row">
                    <div class="table-responsive" id="orderTable">
                        <h3 class="text-success text-center">Chargement des repassages...</h3>
                    </div>
                    </div>        
            </section>
             ...
             <div class="modal-dialog">
               <div class="modal-content">
                <div class="modal-header" id="titreform">
                    <h5 class="modal-title" id="createModalLabel">Planifier un repassage</h5>
                ...
                <div class="modal-body">
                    ...
                    <form id="formOrder" action="" method="post">
                        ...
                        <div class="form-floating mb-3">
                            <textarea  class="form-control" id="comrep" name="comrep" rows="10" cols="5"></textarea>
                            <label for="comrep">Commentaire sur le repassage</label>
                        </div>
                    </form>
                    </div>
    ...
    <script src="../../js/repassage.js"></script>
